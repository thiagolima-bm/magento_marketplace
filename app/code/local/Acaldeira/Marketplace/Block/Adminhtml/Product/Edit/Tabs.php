...
class Acaldeira_Marketplace_Block_Adminhtml_Product_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
     protected $_attributeTabBlock = 'acmarketplace/adminhtml_product_edit_tab_attributes';
    ...
    public function __construct()
    {
        ...
        $this->setTitle(Mage::helper('acmarketplace')->__('Product Information'));
    }
            ...
            foreach ($groupCollection as $group) {
                ...
                $this->addTab('group_'.$group->getId(), array(
                    ...
                    'content'   => $this->_translateHtml($this->getLayout()->createBlock($this->getAttributeTabBlock(),
                        'acmarketplace.adminhtml.product.edit.tab.attributes')->setGroup($group)
