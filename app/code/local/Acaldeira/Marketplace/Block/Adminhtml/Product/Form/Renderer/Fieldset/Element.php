 ...
 */
class Acaldeira_Marketplace_Block_Adminhtml_Product_Form_Renderer_Fieldset_Element
    extends Mage_Adminhtml_Block_Widget_Form_Renderer_Fieldset_Element
{
    ...
    {
        $this->setTemplate('acaldeira/marketplace/catalog/form/renderer/fieldset/element.phtml');
    }
